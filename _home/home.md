...
A central challenge is that we rarely observe transmission events. Much of my recent work addresses this using pathogen genomes: because closely related infections carry nearly identical genomes, **clusters of proximal sequences** contain information about transmission patterns.
Using this signal directly rather than reconstructing full phylogenies makes it possible to analyse very large pathogen sequence datasets. 
I will be recruiting to work on these questions from autumn 2026. If you're interested, please get in touch!